...
public class SiteRestListTest extends TestBase {
  ...
  public void testSiteRestList() throws InterruptedException {
    ...
    String attributeOfImg = app.getMainPgHelper()
    ...
    //System.out.print(app.getMainPgHelper().attribute(By.cssSelector("div[lng='30.39818839999998'] > a.img-outer"), "img")); // выводим то что возвращает метод attribute
